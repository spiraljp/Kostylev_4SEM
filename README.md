...
- [Результат работы](#результат-работы)
  ...
  - [Получение данных через XMLHttpRequest](#получение-данных-через-xmlhttprequest)
  - [Фильтрация карточек](#фильтрация-карточек)
  - [Формирование URL запросов](#формирование-url-запросов)
  - [Страница добавления задания](#страница-добавления-задания)
  - [Страница редактирования задания](#страница-редактирования-задания)
